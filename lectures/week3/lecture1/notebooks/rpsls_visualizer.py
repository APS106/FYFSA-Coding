...
def visualizer(player1, player2, winner):
    ...
    Example:
        rpsls_visualizer('Rock', 'Paper', 'player1')
        rpsls_visualizer('Scissors', 'Rock', 'player2')
    """
    ...
    # Player 1
    player1_image = mpimg.imread('{}.png'.format(player1.lower()))
    ...
    # VS
    player1_image = mpimg.imread('vs.png')
    ...
    # Player 2
    player2_image = mpimg.imread('{}.png'.format(player2.lower()))
